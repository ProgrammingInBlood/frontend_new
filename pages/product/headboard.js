        ...
        <div className="container ">
            <div className="row">
                <div className="col-md-12">
                    ...
                    <p className="mt-8" style={{color:"#141414",fontSize:"15px"}}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed <br /> diam nonumy eirmod tempor invidunt ut labore et dolore <br /> magna aliquyam erat,</p>
...
<div className="single-box">
                               <a href="#"> <Image width={250} height={100} src="/assets/images/DivanBedsicon/Group 477.svg" alt="Product" /></a>
                            ...
                            <div className="single-box">
                               <a href="#"> <Image width={250} height={100} src="/assets/images/DivanBedsicon/Group 478.svg" alt="Product" /></a>
                                <p className="text-center  mt-2" style={{color:"#222178" }}> <b> 2 Seater</b></p>
                            </div>


                            <div className="single-box">
                                <a href="#"><Image width={250} height={100} src="/assets/images/DivanBedsicon/Group 479.svg"  alt="Product"/></a>
                                <p className="text-center  mt-2" style={{color:"#222178" }}> <b> 3 Seater </b></p>
                            </div>

                            <div className="single-box">
                                <a href="#"><Image width={250} height={100} src="/assets/images/DivanBedsicon/Group 480.svg" alt="Product" /></a>
